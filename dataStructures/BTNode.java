...
class BTNode<E> implements Node<E> {
    ...
    /**
     *
     * @return BTNode<E> that is the minimium node
     * Otherwise, when the node has no left child, it return itself
     */
    ...
    /**
     *
     * @return BTNode<E> that is the maximium node
     * Otherwise, when the node has no right child, it return itself
     */
